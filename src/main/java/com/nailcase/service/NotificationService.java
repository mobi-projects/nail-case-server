...
import static com.nailcase.exception.codes.NotificationErrorCode.NOTIFICATION_CONNECTION_ERROR;
import static com.nailcase.exception.codes.NotificationErrorCode.NOTIFICATION_NOT_FOUND;
import static com.nailcase.exception.codes.ReservationErrorCode.RESERVATION_NOT_FOUND;
...
public class NotificationService {
    ...
    private boolean sendToClient(NotificationDto.Request request, Notification notification) {
        ...
        if (request.getNotificationType() == NotificationType.RESERVATION_REQUEST
                ...
                request.getNotificationType() == NotificationType.NEW_CHAT_MESSAGE_TO_SHOP) {
            role = Role.MANAGER;
        } else {
            role = Role.MEMBER;
        }
